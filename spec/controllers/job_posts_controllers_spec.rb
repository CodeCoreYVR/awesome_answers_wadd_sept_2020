...
RSpec.describe JobPostsController, type: :controller do
  describe "#new" do
    it "renders a new template" do
      ...
      # We expect the response to render new.html.erb. For this we'll use 
      # a method called "render_template" which comes with a gem: `rails-controller-testing`
  ...
  describe "#create" do
    ...
    # - for creation we have two different contexts (branches) for our functionality (simulation of create mthod)
      # 1. when data is valid and is being saved
      # 2. when data is not valid and is rolledback
    context "with valid parameters" do
      ...
      it "redirects to the show page of that post" do
        # attributes_for returns a plain hash containing the infomration we passed to the factory:
        post(:create, params: { job_post: FactoryBot.attributes_for(:job_post) })
